...
I denne oppgaven har vi valgt å se på endringen i mengden genuttrykk på MHC1, MHC2a og MHC2x uke 0 til uke 2. 

Vurderingen og tolkningen av tallene for endring i genuttrykket for de ulike typene virker å være fornuftige. Tabell 1 i @terzisResistanceExerciseinducedIncrease2007 viser en blant annet en endring ved en økt prosentandel MHC2a etter 14 uker med styrketrening. @andersenMyosinHeavyChain2000 viser også at styrketrening reduserer MHX2x og øker MHX2a. I denne oppgaven viser tabell 1 at styrketrening gir endringer som at MCH1 har sunket fra 35-27%, MHC2a har økt fra 0,6-72% og MHX2x har sunket fra 63-4%.

Endringen på MHC2a og MHC2x er stor. Dette kan være at dette var gen fra en veldig utrent person, men det kan også være en feil i eksperimentet.  I @andersenMyosinHeavyChain2000  beskrives det at ved å øke muskelaktiviteten, enten gjennom styrke- eller utholdenhetstrening, slås MHC2x-genet av noe som resulterer i en forhøyet andel MHC2a-gen på bekostning av type 2x. Ved inaktivitet reverseres denne prosessen, noe som gjør forekomsten av MHC2x mer vanlig.


Vi har også sett på antall sykluser som trengs for å nå terskel for eksponensiell økning i fluorisense. Lavere antall sykluser viser til større genuttrykk. Genutrykket for MCH2x var eneste genutrykk som trengte flere sykluser for å nå CT-verdi på uke 2. Dette kan være en feil i eksperimentet. Ellers ser vi at antall sykluser har sunket for både MCH1 og MHC2a. 



# Konklusjon

Styrketrening viser seg å gi endringer som en forhøyet andel MHC2a-gen blir mer dominant sammenlignet med type 1 og type 2x.
