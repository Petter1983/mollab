...
Forsøket ble utført over to dager på molekylærlabben på Høgskolen i Innlandet avd. Lillehammer

Vi hadde ferdig cDNA (W0 og W2). Lag et pipetteringsskjema med oversikt over innholdet i alle brønnene på pipetteringsplaten **(?)**. Pipetter 2ul cDNA sammen med 5ul CYBR-green master mix, 1ul av primer mix (MCH1, MHC2a, MHC2x, MCHb2m) og 2ul H~2~O. Gjenta dette slik at du får tre brønner med identisk innhold. Gjør dette med både W0 og W2. Platen skal ogå inneholde en fortynningsserie for både W0 og W2. Forholdene skal være 1/1, 1/10, 1/100, 1/1000, 1/10000, 1/100000 og 1/1000000. Det skal være to brønneer med hver av konsentrasjonene. 1/1 prøven skal inneholde 2ul W0/W2 + 8ul cmyc. Bruk denne prøven som utgangspunkt til å lage fortynningsserien. Fortynn de andre prøvene med **(?)**. Det skal være tre brønner med hver av fortynningene for både W0 og W2.

Når platen er ferdig skal den først dekkes med past og sentrifugferes **(...)** før den skal inn i qPCR-maskinen. Innstillingene på maskinen gjør at prosessen går av seg selv. Prosessen består av en "Hold stage" en "PCR stage" som inneholder 40 sykluser, og avslutningsvis er det en "Melt curve stage". Når maskinen er ferdig kan hente ut resultatene av prøvene i alle brønnene. Resultatene kommer i form av CT.
